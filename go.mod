...
require (
	...
	github.com/metal-toolbox/iam-runtime v0.4.0
	github.com/metal-toolbox/iam-runtime-contrib v0.0.0-00010101000000-000000000000
...
replace github.com/metal-toolbox/iam-runtime-contrib => ../../metal-toolbox/iam-runtime-contrib
